import { AppBar, Box, Container, Link, MenuItem, Select, SvgIcon, SvgIconProps, Toolbar, Typography } from '@mui/material';
        ...
        >
            <Container>
                ...
                <Select
                    ...
                    onChange={event =>
                        i18n.changeLanguage(event.target.value as keyof typeof LanguageName)
                    }
                >
