...
export class MainNavigator extends Component {
  ...
  @observable accessor settingExpand = false;
  @observable accessor menuAnchor: HTMLButtonElement = null;
  @observable accessor settingAnchor: HTMLButtonElement = null;

  toggleMenu = (menuExpand: boolean) => (this.menuExpand = menuExpand);
